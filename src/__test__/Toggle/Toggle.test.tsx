...
describe(`Testing -> Toggle`, () => {
    ...
    it(`to sync the value, options and onClick functionality with true value`, async () => {
        ...
        const { container } = render(<Toggle value={true} options={ {first: 'hello', second: 'world'}} onClick={(e)=>{console.log(e)}} />);
    ...
    it(`to sync the value, options and onClick functionality with false value`, async () => {
        const logSpy = jest.spyOn(console, 'log');
        const { container } = render(<Toggle value={false} options={ {first: 'hello', second: 'world'}} onClick={(e)=>{console.log(e)}} />);
