...
const Toggle: React.FC<ToggleProps> = (props: ToggleProps) => {
	return (
		...
		>
			...
			<button
				className={classNames(
					`absolute cursor-pointer ml-[112px] rounded-[100px] border-none leading-[19px] w-[50%] py-[5%] px-[5%] font-['Lato'] font-[500] text-[1rem] text-white`
				)}
			...
			<button
				className={classNames(
					`rounded-full transition-transform ease-linear duration-200 border-none leading-[19px] w-[50%] py-[5%] px-[5%] bg-[#1da0bc] z-10 font-['Lato'] font-[500] text-[1rem] text-white cursor-pointer`,
