...
const LinearProgressBar: React.FC<LinearProgressBarProps> = (props) => {
	return (
		<>
			{props.value > 0 ? (
				<div data-testid='test1' className={`relative w-100 h-3 m-4-t br-10 overflow-x-hidden ${props.className}`} style={props.style}>
				...
				<div  data-testid='test2' className={`relative w-100 h-3 m-4-t br-10 overflow-x-hidden ${props.className}`} style={props.style}>
					<div className={`absolute w-100 h-3 br-10 bg-43`} style={{ background: `${props.backgroundColor}` }} />
