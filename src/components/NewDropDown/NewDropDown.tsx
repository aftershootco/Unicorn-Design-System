...
export interface NewDropdownData {
...
export interface NewDropDownProps {
	 ...
	 */
	data: {
		[key: string | number]: NewDropdownData
	}
	 ...
	 */
	onChange: (clickedOn: NewDropdownData) => void
	 ...
	 */
	placeholderData?: { [key: string | number]: NewDropdownData }
...
const NewDropDown: React.FC<NewDropDownProps> = (props: NewDropDownProps) => {
	...
	const handleChange = (profile: NewDropdownData) => {
